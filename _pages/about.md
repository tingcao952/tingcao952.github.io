...
- **September 21, 2026:** We released [Zeva-Ego: Egocentric Mid-Training with In-Context Causal Learning for Robot Manipulation](https://air-embodied-brain.github.io/Zeva-Ego/), the first framework to learn causal priors for robot manipulation from unlabeled egocentric video.

## About Me

Dr. Ting Cao is a Professor at the Institute for AI Industry Research (AIR), Tsinghua University. Her research centers on **embodied intelligence**, with a particular focus on self-evolving physical intelligence: building closed-loop systems in which embodied agents continually learn from interaction, improve their causal understanding, and translate that knowledge into more generalizable behavior. Her broader interests include Edge AI, AI training and inference systems, and novel AI accelerators.

Her work spans the full embodied intelligence stack, from learning and reasoning algorithms to efficient systems and hardware. It has been published at leading systems venues, including **ISCA, ASPLOS, MobiCom, MobiSys, NSDI, OSDI, PLDI, EuroSys, SC, and PPoPP**, and AI venues including **ICCV, ICLR, NeurIPS, and ACL**.
...
Dr. Cao's research has also significantly advanced AI on edge devices, enabling complex deep neural networks and large language models to run directly on [consumer devices such as smartphones and PCs](https://www.microsoft.com/en-us/research/blog/achieving-zero-cogs-with-microsoft-editor-neural-grammar-checker/) while reducing cloud operational costs. Her innovations have been integrated into products used by millions, including Microsoft Office, Windows, Bing, and Huawei HarmonyOS.

## Research Highlights

### Self-Evolving Embodied Intelligence

- [Zetta ζ: An Efficient Closed-Loop Embodied Harness for Self-Evolving Physical Intelligence](https://air-embodied-brain.github.io/zetta/)
- [Zeva: In-Context Causal Learning for Generalizable Embodied Manipulation](https://air-embodied-brain.github.io/Zeva/)
- [Zeva-Ego: Egocentric Mid-Training with In-Context Causal Learning for Robot Manipulation](https://air-embodied-brain.github.io/Zeva-Ego/)

### Selected Systems and AI Work

- [Low-bit and table-lookup techniques for LLM inference](https://mp.weixin.qq.com/s/xOaOCLu4fdpx0-IVB0UnTg)
- [Large-model accelerators built with commodity DRAM](https://mp.weixin.qq.com/s/n1ZRa0g98YGuxTKxAES_AQ)
- [StreamMind for continuous video understanding](https://mp.weixin.qq.com/s/rGTV4zbxi-fhtOmpbRqPRw)
- [V-Droid, a near-real-time GUI agent](https://mp.weixin.qq.com/s/GxTJrTp-gfg0N1wchpYptg)
- [The Cloud for Science paradigm](https://mp.weixin.qq.com/s/f_Qr3tNfpvSAdRbt0JFx0Q)
